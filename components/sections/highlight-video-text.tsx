      ...
      <div className="space-y-8">
        ...
        <div className="bg-slate-900/50 p-6 rounded-lg">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl font-bold">
              Size Özel Profesyonel Highlight Video Hizmeti:
            </h3>
          </div>
          <ul className="space-y-2 ml-6 text-gray-300">
            ...
            <li className="list-disc">Profesyonel kurgu ve düzenleme</li>
            <li className="list-disc">
        ...
        <div className="bg-slate-900/20 p-6 rounded-lg">
          ...
          <ul className="space-y-2 ml-6 text-gray-300">
            ...
            <li className="list-disc">Üniversite takımları</li>
            <li className="list-disc">Profesyonel kulüp seçmeleri</li>
            <li className="list-disc">Yetenek avcılarına ulaşmak</li>
          </ul>
        </div>

        <div className="text-center space-y-4">
          <p className="text-lg font-bold">
            Sizin için buradayız! Hayallerinize giden yolda profesyonel
            desteğimizle fark yaratın.
          </p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="flex items-center gap-2 bg-default-black text-default-white px-6 py-3 rounded-full hover:bg-default-black/20 transition-colors border border-default-white"
            >
            ...
            <Link
              href="/apply"
              className="flex items-center gap-2 bg-default-white text-default-black px-6 py-3 rounded-full hover:bg-gray-100 transition-colors"
            >
